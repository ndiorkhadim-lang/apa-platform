        ...
        <section aria-label="Recommended solutions">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {profile.recSolutions.map((s) => (
              <Link key={s} href="/certification" className="rounded-full border border-apa-sage bg-apa-soft px-3.5 py-1.5 text-sm font-semibold text-apa-green hover:bg-apa-green hover:text-white">
                {SOLUTION_LABEL[s] ?? s}
              </Link>
            ))}
          </div>
